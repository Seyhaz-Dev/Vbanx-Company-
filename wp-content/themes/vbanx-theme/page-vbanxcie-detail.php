...
$product = array(
	...
	'title'    => 'VBANXCIE',
	'summary'  => 'Connects to any core banking system to automate CIFRS 9, 16, 19 and CAR ratio calculations and regulatory reports in real time.',
	'badge'    => 'Compliance Engine',
	'features' => array(
		array(
			'name' => 'Connects to any core banking system',
		...
		array(
			'name' => 'Calculates CIFRS 9, 16, 19 and CAR ratio',
			'desc' => 'Streamlined trust setup and management with compliance automation.',
		),
		array(
			'name' => 'Regulatory reports in real time',
			'desc' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since 1966, when designers at Letraset and James Mosley, the librarian at St Bride Printing Library in London, took a 1914 Cicero translation and scrambled it to make dummy text for Letraset\'s Body Type sheets',
		),
