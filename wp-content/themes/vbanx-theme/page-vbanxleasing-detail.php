<?php
/**
 * Template Name: VBANX Leasing Detail
...
$product = array(
	...
	'title'    => 'VBANXLEASING',
	'summary'  => 'End-to-end lease origination, scheduling, fixed asset tracking and CIFRS 16 lease accounting in one workflow.',
	'badge'    => 'Leasing',
	'features' => array(
		array(
			'name' => 'Lease Origination',
		...
		array(
			'name' => 'Scheduling',
			'desc' => 'Streamlined scheduling of lease agreements and related activities.',
		),
		array(
			'name' => 'Fixed Asset Tracking',
			'desc' => 'Comprehensive tracking of fixed assets throughout the lease lifecycle.',
		),
		array(
			'name' => 'CIFRS 16 Lease Accounting',
			'desc' => 'Seamless integration of CIFRS 16 lease accounting requirements into the workflow.',
		),
