<?php
/**
 * Template Name: VBANX Pawn Detail
...
$product = array(
	...
	'title'    => 'VBANXPAWN',
	'summary'  => 'Ticketing, collateral valuation, redemption and default handling built for the pace of pawn shop operations.',
	'badge'    => 'Pawn Shop',
	'features' => array(
		array(
			'name' => 'Ticketing',
		...
		array(
			...
			'desc' => 'Accurate and efficient collateral assessment for pawn shop operations.',
		),
		array(
			'name' => 'Redemption',
			'desc' => 'Streamlined redemption process for customers to retrieve their pledged items.',
		),
		array(
			'name' => 'Default Handling',
			'desc' => 'Comprehensive default handling procedures to manage non-performing loans.',
		),
