...
=======
            $body  = "New contact form submission from the VBANX Ecosystem site:\n\n";
>>>>>>> 1bca7dc6a59639310dc5a7115d11ee16483b0259
        ...
        <div class="contact-panel">
            ...
            <div class="contact-info">
                <div class="contact-info-inner">
                    <h2><?php echo esc_html(get_field('contact_intro_title')); ?></h2>
                    <p><?php echo esc_html(get_field('contact_intro_description')); ?></p>

                    <ul class="contact-details">
                        <?php if (get_field('contact_phones')): ?>
                        <li>
                            <span class="contact-icon">📞</span>
                            <span><?php echo esc_html(get_field('contact_phones')); ?></span>
                        </li>
                        <?php endif; ?>
                        ...
                        <li>
                            <span class="contact-icon">📍</span>
                            <span><?php echo nl2br(esc_html(get_field('contact_address'))); ?></span>
                        </li>
                        <?php endif; ?>
                        ...
                        <li>
                            <span class="contact-icon">🌐</span>
                            <span><?php echo esc_html(get_field('contact_website')); ?></span>
                        </li>
                        <?php endif; ?>
                    </ul>
                    ...
                    <div class="contact-social">
                        <?php if (get_field('social_twitter')): ?>
                            <a href="<?php echo esc_url(get_field('social_twitter')); ?>" target="_blank" rel="noopener" aria-label="Twitter">𝕏</a>
                        <?php endif; ?>
                        <?php if (get_field('social_instagram')): ?>
                            <a href="<?php echo esc_url(get_field('social_instagram')); ?>" target="_blank" rel="noopener" aria-label="Instagram">◎</a>
                        <?php endif; ?>
                        <?php if (get_field('social_discord')): ?>
                            <a href="<?php echo esc_url(get_field('social_discord')); ?>" target="_blank" rel="noopener" aria-label="Discord">◈</a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="contact-info-decor" aria-hidden="true"></div>
            </div>
